...
namespace Feree.ResultType
{
    public static class ResultFactory
    {
        ...
        public static IResult<Empty> CreateSuccess() => new Success();
        ...
        public static IResult<Empty> CreateFailure(IError error) => new Failure(error);
        public static IResult<Empty> CreateFailure(string message) => new Failure(new Error(message));
        ...
        public static async Task<IResult<Empty>> CreateFailure(Task<IError> error) => new Failure(await error);
        public static async Task<IResult<Empty>> CreateFailure(Task<string> message) => new Failure(new Error(await message));
    }
}